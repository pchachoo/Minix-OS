...
// System calls implemented for the IPC

#define CREATEMAILBOX  35  /* Create mailbox */
#define REMOVEMAILBOX  44   /* Remove the mailbox */
#define REMOVESENDER  56    /* Remove the sender */
#define MRECEIVE  58        /* Do the Mreceive */
#define MSEND  69           /* Do the Msend */
#define ADDSENDER  70       /* Add a sendr */
